...
class RouteConfigPayload(BaseModel):
    ...
    provider: str = Field(..., description="Primary LLM provider (openai, anthropic, google, local)")
    fallback_provider: str = Field(..., description="Fallback LLM provider (openai, anthropic, google, local)")
